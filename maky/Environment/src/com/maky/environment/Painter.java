...
public class Painter {
	...
	private List graphicsComponents;
	...
	public Painter() {
		graphicsComponents = new ArrayList();
	...
	public void paint(AppGraphics gr) {
		...
		if (componentsChanged) {
			synchronized (this) {
				...
				paintComponents = (IPaintable[]) graphicsComponents.toArray(new IPaintable[graphicsComponents.size()]);
			}
		}
