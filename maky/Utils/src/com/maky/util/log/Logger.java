...
public class Logger {
	...
	public void logError(String msg) {
		System.out.println(className.concat(" ERROR:").concat(msg));
	}

	public void logDebug(String msg) {
		if (DO_DEBUG) {
			System.out.println(className.concat(" DEBUG:").concat(msg));
		}
	}
	...
	public void logInfo(String msg) {
		if (DO_INFO) {
			System.out.println(className.concat(" INFO:").concat(msg));
		}
	}

	public void logNotice(String msg) {
		if (DO_NOTICE) {
			System.out.println(className.concat(" NOTICE:").concat(msg));
		}
	}
